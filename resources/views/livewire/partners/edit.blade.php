                ...
                <form method="POST" action="{{ route('update', $partner->id) }}" class="text-secondary">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" name="name" id="Name" class="form-control" placeholder="Nome" value="{{ $partner->name }}" aria-label="Nome" aria-describedby="addon-wrapping">
                            @if ($errors->any())
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="email" id="Email" class="form-control" placeholder="E-mail" value="{{ $partner->email }}" aria-label="Email" aria-describedby="addon-wrapping">
                            @if ($errors->any())
                    ...
                    <div class="row mt-2">
                        <div class="col-auto">
                            ...
                            <select name="type" id="Type" class="form-select" aria-label="Default select example">
                                <option value="silver" @if($partner->type === "Silver")  selected @endif>Silver</option>
                                <option value="gold" @if($partner->type === "Gold")  selected @endif>Gold</option>
                            </select>
                            @if ($errors->any())
