                ...
                <form method="POST" action="{{ route('update', $partner->id) }}" class="text-secondary">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" name="name" id="Name" class="form-control" value="{{ $partner->name }}" aria-label="Nome" aria-describedby="addon-wrapping">
                            @if ($errors->any())
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="email" id="Email" class="form-control" value="{{ $partner->email }}" aria-label="Email" aria-describedby="addon-wrapping">
                            @if ($errors->any())
